...
import com.czhappy.commonindexdemo.activity.IntroduceActivity;
...
//        }
        ...
        cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("name", campaign.getCampaign_name());
                intent.putExtras(bundle);
                intent.setClass(mContext, IntroduceActivity.class);
