...
import com.czhappy.commonindexdemo.dialog.OneButtonDialog;
import com.czhappy.commonindexdemo.domain.SeatMo;
import com.czhappy.commonindexdemo.gesturedetectors.MoveGestureDetector;
import com.czhappy.commonindexdemo.listener.MyOnDialogClickListener;
import com.czhappy.commonindexdemo.view.SeatTableView;
...
public class ConfirmActivity extends BaseActivity implements View.OnClickListener, View.OnTouchListener {
    ...
    protected void initComponent() {
        ...
        MyOnDialogClickListener onDialogClickListener = new MyOnDialogClickListener(ConfirmActivity.this);
...
//        rowView.startAnimation(alpha);
        for (int i = 0; i < seatTableView.getRowSize(); i++) {
            TextView textView = new TextView(ConfirmActivity.this);
            //座位有可能为空
